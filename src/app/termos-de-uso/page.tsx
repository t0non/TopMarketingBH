      ...
      <main className="flex-1 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="prose max-w-3xl mx-auto">
            ...
            <h2>1. Termos</h2>
            <p>
              Ao acessar ao site Top Marketing BH, concorda em cumprir estes
            ...
            <p>
              ...
              materiais (informações ou software) no site Top Marketing BH ,
            ...
            <ol>
              ...
              <li>
                ...
                software contido no site Top Marketing BH;
              </li>
              <li>
            ...
            <p>
              ...
              dessas restrições e poderá ser rescindida por Top Marketing BH a
            ...
            <ol>
              <li>
                Os materiais no site da Top Marketing BH são fornecidos 'como
                estão'. Top Marketing BH não oferece garantias, expressas ou
              ...
              <li>
                Além disso, a Top Marketing BH não garante ou faz qualquer
            ...
            <h2>4. Limitações</h2>
            <p>
              Em nenhum caso o Top Marketing BH ou seus fornecedores serão
              ...
              materiais em Top Marketing BH, mesmo que Top Marketing BH ou um
              representante autorizado da Top Marketing BH tenha sido notificado
            ...
            <p>
              Os materiais exibidos no site da Top Marketing BH podem incluir
              erros técnicos, tipográficos ou fotográficos. Top Marketing BH
              não garante que qualquer material em seu site seja preciso,
              completo ou atual. Top Marketing BH pode fazer alterações nos
              materiais contidos em seu site a qualquer momento, sem aviso
              prévio. No entanto, Top Marketing BH não se compromete a
              atualizar os materiais.
            </p>
            <h2>6. Links</h2>
            <p>
              O Top Marketing BH não analisou todos os sites vinculados ao seu
              site и não é responsável pelo conteúdo de nenhum site vinculado. A
              inclusão de qualquer link não implica endosso por Top Marketing
              BH do site. O uso de qualquer site vinculado é por conta e risco
              do usuário.
            </p>
            <h3>Modificações</h3>
            <p>
              O Top Marketing BH pode revisar estes termos de serviço do site a
            ...
            <p>
              ...
              as leis do Top Marketing BH e você se submete irrevogavelmente à
